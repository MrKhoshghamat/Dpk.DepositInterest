...
using Dpk.DepositInterest.Modules.Administration.Application.Configuration.Queries;
using Dpk.DepositInterest.Modules.Administration.Application.Contracts;
using Dpk.DepositInterest.Modules.Administration.ArchTests.SeedWork;
...
namespace Dpk.DepositInterest.Modules.Administration.ArchTests.Application
{
    [TestFixture]
