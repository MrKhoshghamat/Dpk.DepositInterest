...
using Dpk.DepositInterest.Modules.Administration.Domain.MeetingGroupProposals.Events;
using Dpk.DepositInterest.Modules.Administration.Domain.MeetingGroupProposals.Rules;
...
namespace Dpk.DepositInterest.Modules.Administration.Domain.UnitTests.MeetingGroupProposals
{
    [TestFixture]
