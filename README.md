...
<Project Sdk="MSBuild.Sdk.SqlProj/1.6.0">
    ...
    <ItemGroup>
        <Content Include="..\Dpk.DepositInterest.Database\administration\**\*.sql" />
        <Content Include="..\Dpk.DepositInterest.Database\app\**\*.sql" />
        <Content Include="..\Dpk.DepositInterest.Database\meetings\**\*.sql" />
        <Content Include="..\Dpk.DepositInterest.Database\payments\**\*.sql" />
        <Content Include="..\Dpk.DepositInterest.Database\users\**\*.sql" />
        <Content Include="..\Dpk.DepositInterest.Database\Security\**\*.sql" />
    </ItemGroup>
</Project>
```
...
- Create an empty database using [CreateDatabase_Windows.sql](src/Database/Dpk.DepositInterest.Database/Scripts/CreateDatabase_Windows.sql) or [CreateDatabase_Linux.sql](src/Database/Dpk.DepositInterest.Database/Scripts/CreateDatabase_Linux.sql). Script adds **app** schema which is needed for migrations journal table. Change database file path if needed.
...
- Execute [SeedDatabase.sql](src/Database/Dpk.DepositInterest.Database/Scripts/SeedDatabase.sql) script
...
Include the credentials of a test user created in the [SeedDatabase.sql](src/Database/Dpk.DepositInterest.Database/Scripts/SeedDatabase.sql) script - for example:
