...
public partial class Build
{
    ...
    static AbsolutePath DatabaseDirectory =>
        RootDirectory / "src" / "Database" / "Dpk.DepositInterest.Database" / "Scripts";
    ...
    const string MeetingsModuleIntegrationTestsAssemblyName = "Dpk.DepositInterest.Modules.Meetings.IntegrationTests";
    ...
    const string AdministrationModuleIntegrationTestsAssemblyName = "Dpk.DepositInterest.Modules.Administration.IntegrationTests";
    ...
    const string PaymentsModuleIntegrationTestsAssemblyName = "Dpk.DepositInterest.Modules.Payments.IntegrationTests";
    ...
    const string SystemIntegrationTestsAssemblyName = "Dpk.DepositInterest.IntegrationTests";
